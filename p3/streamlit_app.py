...
def main():
    ...
    if option == "Generate Random File":
        ...
        changes.append(f"Generated random file with {num_lines} lines.")
        ...
        if uploaded_file is not None:
            ...
            changes.append("Uploaded file successfully.")

    for change in changes:
        st.sidebar.write(change)
    ...
    if st.button("Relocate"):
        if n == m:
            ...
            changes.append(f"Line {n} relocated after Line {m}.")
